#!/usr/bin/env python3
"""
main_enhanced.py - Table project with mouse controls for camera rotation and table adjustment
"""
...
class TabletopConfig:
    ...
    original_size: Vector3D = field(init=False)  # Store original size for reset
...
# =============================================================================
# Enhanced Table Renderer with Adjustable Tabletop
# =============================================================================
...
class EnhancedTableRenderer:
    ...
    def setup_shaders(self):
        ...
        void main() {
            ...
            // Calculate normal from position (approximate for cube)
            frag_normal = normalize(cross(dFdx(frag_position), dFdy(frag_position)));
...
def main():
    if len(sys.argv) != 3:
        print("Usage: python main_enhanced.py shapes.json joints.json")
        sys.exit(1)
